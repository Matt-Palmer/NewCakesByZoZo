...
<div id="home" class="content-container">
    ...
    <div class="page-content">
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-4 col-xl-3 no-rl-padding">
                        <div class="card">
                            ...
                            <div class="card-block no-rl-padding">
                                ...
                                <p class="date-and-time"><small class="fa fa-calendar"><?php echo $post_date;?></small></p>
        ...
        <section class="light">
            <h2>Gallery</h2>
                ...
                <div class="col-xs-12 col-md-6 col-lg-4 col-xl-3 padding-right-left">
                    ...
                    <?php 
                        ...
                        echo '</div>';
                        echo "<p class='album-title secondary-btn'>$album_title</p>";
                        echo '</a>';
            ...
            <div class="btn-container">
                <a href="something.php" class="button main-btn">View All Albums</a>
            </div>
        </section>
